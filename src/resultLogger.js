...
function saveResult(formattedData, fileName = "baseline_result.json") {
  ...
  if (
    formattedData.scenario_name &&
    formattedData.scenario_name.includes("Sandwich")
  ) {
    csvPath = path.join(resultsDir, "sandwich_attack_summary.csv");
    header =
      "scenario_name,fork_block,dex,input_token,output_token,victim_input_amount,baseline_expected_output,attacked_actual_output,victim_output_loss,financial_loss_percentage,attacker_gas_used,status\n";
    ...
    formattedData.scenario_name &&
    formattedData.scenario_name.includes("Protected")
  ) {
...
`;
    ...
    header =
      "scenario_name,fork_block,dex,input_token,output_token,input_amount,expected_output,actual_output,gas_used,status\n";
